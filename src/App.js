// zippee-frontend - File src/App.js - v19
...
import EndUserTripDetails from './components/EndUserTripDetails';
import WelcomePage from './components/WelcomePage'; // Importa il nuovo componente
        ...
        <ThemeProvider theme={currentTheme}>
            ...
            <Router>
                ...
                <Routes>
                    ...
                    <Route path="/enduser/trip/:ecoTripCode" element={<EndUserTripDetails />} />
                    <Route path="/welcome" element={<WelcomePage />} /> {/* Nuova route per la pagina di benvenuto */}
                </Routes>
            </Router>
        </ThemeProvider>
    );
