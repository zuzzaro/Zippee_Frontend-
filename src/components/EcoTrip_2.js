// File: src/components/EcoTrip.js - v2
...
function EcoTrip() {
    ...
    navigate(`/dashboard/eco-trip/${tripId}`); // Corretto: usa /dashboard/eco-trip/
    };
                        ...
                        <TableBody>
                            {sortedTrips.map((trip) => (
                                <TableRow
                                    key={trip.id}
                                    hover
                                    onClick={() => handleRowClick(trip.id)} // Aggiungi il gestore di click
                                    style={{ cursor: 'pointer' }} // Cambia il cursore per indicare che la riga è cliccabile
                                >
