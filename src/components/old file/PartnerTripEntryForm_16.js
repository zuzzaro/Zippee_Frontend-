// File: src/components/PartnerTripEntryForm.js - v16
...
import { QRCodeSVG } from 'qrcode.react'; // Aggiunto: Import per il codice QR
...
function PartnerTripEntryForm() {
    ...
    const [tripId, setTripId] = useState(null); // Aggiunto: Stato per l'ID del viaggio
    const [qrCodeUrl, setQrCodeUrl] = useState(''); // Aggiunto: Stato per l'URL del codice QR
    ...
    const handleSubmit = async (event) => {
        ...
        const tripData = {
            ...
            date_departure: dataPartenza ? dataPartenza.toISOString() : null, // Aggiunto: Invia la data di partenza
        };
        ...
        try {
            ...
            // Aggiunto: Salva l'ID del viaggio e genera l'URL per il codice QR
    ...
    // Aggiunto: Debug per lo stato qrCodeUrl
    useEffect(() => {
                ...
                <Box mt={5}>
                    ...
                    <form onSubmit={handleSubmit}>
                        <Grid container spacing={3}>
                            ...
                            {/* Aggiunto: Visualizzazione del codice QR */}
                            {qrCodeUrl && (
                                <Grid item xs={12}>
