// zippee-frontend - File src/components/PartnerTripEntryForm.js - v22
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            reader.onloadend = async () => {
                const base64Data = reader.result.split(',')[1]; // Rimuove il prefisso "data:application/pdf;base64,"

                // Invia il PDF al backend per salvarlo
                const saveResponse = await axios.post(
                    'http://localhost:3000/api/save-pdf',
                    {
                        fileName: `${ecoTripCode}.pdf`,
                        pdfData: base64Data,
                    },
                    {
                        headers: {
                ...
                // Imposta l'URL pubblico del PDF per il QR code
