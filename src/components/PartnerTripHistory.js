// File: src/components/PartnerTripHistory.js - v5
...
function PartnerTripHistory() {
    ...
    const handleRowClick = (tripId) => {
        navigate(`/trip/${tripId}`); // Reindirizza alla view dei dettagli del viaggio
    };
        ...
        <Container maxWidth="md">
            ...
            <Box display="flex" justifyContent="space-between" mb={3}>
                <FormControl variant="outlined" sx={{ minWidth: 200 }}>
                    <InputLabel>Filter trips</InputLabel>
                    <Select
                        value={filter}
                    ...
                    >
                        ...
                        <MenuItem value="with_code">With certificate</MenuItem>
                        <MenuItem value="without_code">Without certificate</MenuItem>
                    </Select>
                </FormControl>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {paginatedTrips.map((trip) => (
                                    <TableRow
                                        key={trip.id}
                                        onClick={() => handleRowClick(trip.id)} // Gestisce il click sulla riga
