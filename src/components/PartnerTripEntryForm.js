// zippee-frontend - File src/components/PartnerTripEntryForm.js - v29
...
function PartnerTripEntryForm() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const url = `http://localhost:3001/welcome?ecoTripCode=${code}`; // Modifica l'URL per puntare alla pagina di benvenuto
            setTripId(tripId);
            setQrCodeUrl(url);
