// File: src/components/EcoTripCompensation.js - v12
...
import { Edit as EditIcon, Close as CloseIcon } from '@mui/icons-material'; // Importa le icone
                ...
                <Paper elevation={3} sx={{ p: 3, mt: 3 }}>
                    ...
                    <Box mt={3} display="flex" justifyContent="space-between">
                        <Button
                            variant="contained"
                            color="primary"
                            startIcon={<CloseIcon />} // Icona di uscita
                            onClick={handleExit}
