// zippee-frontend - File src/App.js - v18
...
import EndUserTripDetails from './components/EndUserTripDetails'; // Importa il nuovo componente
        ...
        <ThemeProvider theme={currentTheme}>
            ...
            <Router>
                ...
                <Routes>
                    ...
                    <Route path="/enduser/trip/:ecoTripCode" element={<EndUserTripDetails />} /> {/* Route dinamica per enduser con EcoTrip Code */}
                </Routes>
            </Router>
        </ThemeProvider>
    );
